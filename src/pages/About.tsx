        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[1, 2, 3, 4].map((member) => (
                <div key={member} className="bg-secondary rounded-xl overflow-hidden text-center group">
                  <div className="aspect-square bg-gray-800"></div>
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-white mb-1">Team Member {member}</h3>
                    <p className="text-accent-light mb-3">Core Developer</p>
                    <p className="text-gray-300 mb-4 text-sm">
                      Experienced blockchain developer with expertise in smart contract development and Web3 integration.
                    </p>
