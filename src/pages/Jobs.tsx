...
const sampleJobs = [
	{
		...
		description:
			"Develop a secure escrow contract for a real estate platform. Must have experience with Solidity and Hardhat.",
		price: "1.2",
		category: "Blockchain",
		deadline: "10 days",
	...
	},
	{
		...
		description:
			"Build responsive UI components for our Web3 integration. Experience with ethers.js and React required.",
		price: "0.8",
	...
	},
	{
		...
		description:
			"Create engaging blog posts explaining DeFi concepts to beginners. Must understand blockchain fundamentals.",
		price: "0.3",
		category: "Content",
		deadline: "5 days",
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-primary via-secondary to-primary relative overflow-hidden">
			...
			<div className="absolute top-0 left-0 w-full h-full">
				...
				<div
					className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-blue-400/10 to-purple-500/10 rounded-full blur-3xl animate-pulse"
			...
			<div className="pt-36 pb-20 px-4 relative z-10">
				<div className="container mx-auto">
					...
					<div className="text-center mb-12 animate-fade-in">
						...
						<p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
							Browse through available jobs or use filters to find the perfect
							match for your skills in the{" "}
					...
					<div
						className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 mb-12 border border-white/20 shadow-2xl animate-fade-in"
					...
					>
						...
						>
							<div className="relative flex-grow group">
								<Search
									className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-accent-light transition-colors"
									size={20}
								/>
								<Input
									type="text"
							...
							<Button
								type="submit"
								className="bg-gradient-to-r from-accent-light to-yellow-500 text-white hover:from-accent hover:to-orange-500 h-14 px-8 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2"
							>
								<Filter size={18} />
								Search Jobs
							</Button>
								...
								<Button
									...
									className={
										selectedCategory === category
											? "bg-gradient-to-r from-accent-light to-yellow-400 text-white hover:from-accent hover:to-orange-500 border-0 shadow-lg transform hover:scale-105 transition-all duration-300"
