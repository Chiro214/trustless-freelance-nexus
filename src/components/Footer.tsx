        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/jobs" className="text-gray-300 hover:text-accent transition-colors">Browse Jobs</Link></li>
              <li><Link to="/post-job" className="text-gray-300 hover:text-accent transition-colors">Post a Job</Link></li>
              <li><Link to="/how-it-works" className="text-gray-300 hover:text-accent transition-colors">How It Works</Link></li>
              <li><Link to="/fees" className="text-gray-300 hover:text-accent transition-colors">Fee Structure</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/faq" className="text-gray-300 hover:text-accent transition-colors">FAQ</Link></li>
              <li><Link to="/tutorials" className="text-gray-300 hover:text-accent transition-colors">Tutorials</Link></li>
              <li><Link to="/blog" className="text-gray-300 hover:text-accent transition-colors">Blog</Link></li>
              <li><Link to="/documentation" className="text-gray-300 hover:text-accent transition-colors">Documentation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/community" className="text-gray-300 hover:text-accent transition-colors">Community</Link></li>
              <li><Link to="/support" className="text-gray-300 hover:text-accent transition-colors">Support</Link></li>
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/privacy" className="text-gray-400 hover:text-accent text-sm transition-colors">Privacy Policy</Link>
            </div>
          </div>
        </div>
      </div>
